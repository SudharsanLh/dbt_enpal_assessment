  ...
  create  table "postgres"."master"."master_deal__dbt_tmp"
...
( 
    ...
    from "postgres"."staging"."stg_deal_changes" sd 
    left join "postgres"."staging"."stg_lost_fields" sf on sd.new_value = sf.lost_id
